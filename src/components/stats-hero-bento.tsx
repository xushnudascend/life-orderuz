...
export function StatsHeroBento({
  ...
  return (
    <section
        ...
        className="relative h-full overflow-hidden rounded-[32px] border border-border/40 bg-secondary p-6 sm:p-8 backdrop-blur-4xl shadow-premium"
      >
        ...
        <div className="relative z-10 mt-10 grid grid-cols-2 gap-4">
          <Link
            to="/habits"
            className="group relative overflow-hidden rounded-[20px] border border-border/60 bg-tertiary p-5 transition-all hover:border-primary/50 hover:bg-primary/5 hover:shadow-[0_0_20px_hsl(var(--primary)/0.15)]"
          >
