  ...
  return (
    <AppShell title="Dashboard">
      ...
      <div className="mt-4">
        ...
        {/* Habits */}
        <Panel className="lg:col-span-12 rounded-[32px] border-border/40 bg-secondary backdrop-blur-4xl p-6 sm:p-8 shadow-premium">
                    ...
                    <button
                      ...
                      className={
                        ...
                        (isDone
                          ...
                          : "border-border/60 bg-tertiary hover:border-primary/40 hover:bg-primary/[0.02]")
                      }
                    >
                      <span
                        className={
