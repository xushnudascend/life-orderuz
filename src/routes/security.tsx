...
export const Route = createFileRoute("/security")({
  ...
  component: () => (
    <LegalShell title="Xavfsizlik" updated="17-iyul, 2026">
      <p>
        Xavfsizlik keyin qo'shiladigan qatlam emas — birinchi qadamdan boshlab
        loyihaga singdirilgan. Quyida to'g'ridan-to'g'ri qo'llagan choralarimiz.
      </p>

      <h2 className="mt-8 font-serif text-2xl">Autentifikatsiya</h2>
      <ul className="ml-5 list-disc space-y-1.5">
        <li>Parollar <strong>bcrypt</strong> (cost 10+) bilan xeshlanadi — hech qachon ochiq saqlanmaydi.</li>
        <li>Ro'yxatdan o'tishda <strong>HIBP</strong> orqali buzilgan parollar rad etiladi.</li>
      ...
      <ul className="ml-5 list-disc space-y-1.5">
        <li>Har jadval <strong>Row-Level Security</strong> siyosati bilan yopiq — foydalanuvchi faqat o'z qatorlarini ko'radi.</li>
        <li>Rollar (admin, moderator) alohida jadvalda — imtiyoz eskalatsiyasi imkonsiz.</li>
        <li>Server maxfiy kalitlari (<code>service_role</code>) brauzerga hech qachon yubormaydi.</li>
      ...
      <ul className="ml-5 list-disc space-y-1.5">
        <li>Barcha trafik <strong>TLS 1.3</strong> orqali shifrlanadi. HTTP → HTTPS majburiy redirect.</li>
      ...
      <ul className="ml-5 list-disc space-y-1.5">
        <li>Ishlab chiqarish xatoliklari <strong>Sentry</strong> orqali kuzatiladi — PII avtomatik filtrlanadi.</li>
      ...
      <p>
        ...
        yozing. Ommaviy oshkor qilishdan avval 90 kun beramiz. Mas'uliyatli
        xabar bergan tadqiqotchilarga rahmatnoma va (imkoni bo'lsa) mukofot beriladi.
      </p>
    </LegalShell>
  ),
});
