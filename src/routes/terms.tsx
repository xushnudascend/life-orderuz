...
export const Route = createFileRoute("/terms")({
  ...
  component: () => (
    <LegalShell title="Foydalanish shartlari" updated="17-iyul, 2026">
      <p>
        Xizmatdan foydalanib, siz quyidagilarga rozilik bildirasiz. Muhim
        joylari qalin ajratildi.
      </p>
      ...
      <p>
        ...
        <strong>tibbiy, psixologik yoki huquqiy maslahat emas</strong>. Ruhiy
        yoki jismoniy holatingiz bilan bog'liq jiddiy savollarda mutaxassisga
        murojaat qiling.
      </p>

      <h2 className="mt-8 font-serif text-2xl">2. Hisob va yosh</h2>
      <ul className="ml-5 list-disc space-y-1.5">
        <li>Minimal yosh — <strong>13</strong>. 18 yoshgacha ota-ona ruxsati talab qilinadi.</li>
      ...
      <ul className="ml-5 list-disc space-y-1.5">
        <li>Siz yozgan kundalik, odat va suhbatlar — <strong>sizga tegishli</strong>.</li>
        <li>Bizga faqat xizmatni yetkazish uchun cheklangan litsenziya berasiz (o'qish, ko'rsatish, AI kontekst).</li>
      ...
      <ul className="ml-5 list-disc space-y-1.5">
        ...
        <li>14 kunlik qaytarish kafolati — batafsil <strong>/refund</strong>.</li>
        <li>Narx o'zgarsa — 30 kun oldin xabar beriladi.</li>
      </ul>

      <h2 className="mt-8 font-serif text-2xl">5. Javobgarlik chegarasi</h2>
      <p>
        Xizmat "borligicha" (<em>as is</em>) taqdim etiladi. Biz uzluksiz ishlashni
        kafolatlay olmaymiz. AI javoblari xato bo'lishi mumkin — muhim qarorlar
        uchun tekshiring. Maksimal javobgarligimiz — oxirgi 12 oyda to'lagan
        summangiz miqdorida.
      </p>

      <h2 className="mt-8 font-serif text-2xl">6. Nizolar</h2>
      <p>
        Avval do'stona hal qilishga urinamiz — <strong>legal@lifeorder.app</strong>.
        Kelishuv bo'lmasa, O'zbekiston Respublikasi qonunlari va sudlari
        yurisdiksiyasida ko'riladi.
      </p>

      <h2 className="mt-8 font-serif text-2xl">7. O'zgarishlar</h2>
      <p>
        Shartlar o'zgarsa — 14 kun oldin email va sayt orqali xabar beriladi.
        Davom etib foydalanish — yangi shartlarga rozilik demakdir.
      </p>
