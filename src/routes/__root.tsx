...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Karla:wght@400;500;600;700;800&display=swap",
      },
    ],
    scripts: [
      {
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="uz" data-motion="full" suppressHydrationWarning>
      <head>
        <HeadContent />
      </head>
      <body>
