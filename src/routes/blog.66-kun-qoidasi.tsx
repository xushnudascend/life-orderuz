      ...
      <main className="mx-auto max-w-3xl px-5 py-14">
        <article className="prose prose-invert max-w-none">
          ...
          <p className="mt-6 text-lg leading-relaxed text-muted-foreground text-pretty">
            "21 kunda odat quriladi" — bu afsona. Aslida London Universiteti kolleji tadqiqoti
            (Lally va boshq., 2010) o'rtacha vaqtni <strong>66 kun</strong> deb topgan. Ba'zilarga
            18 kun yetadi, boshqalarga 254 kun kerak. Farq nimadan kelib chiqadi?
          </p>

          <h2 className="mt-12 font-serif text-2xl">Tadqiqot nima ko'rsatgan</h2>
          <p className="mt-3 leading-relaxed text-muted-foreground">
            96 ta ishtirokchi 12 hafta davomida bir xil sharoitda bir xil xatti-harakatni
            takrorlagan (masalan, tushlikdan keyin meva yeyish). Har kuni o'z his-tuyg'ularini yozib
            borgan: "avtomatlashdimi?", "kuch talab qildimi?". Egrilik chizig'i shakli aniq:{" "}
            <strong>boshida tez o'sish</strong>, keyin platoga chiqish. O'rtacha nuqta — 66-kun.
          </p>
          ...
          <ul className="mt-3 space-y-2 leading-relaxed text-muted-foreground">
            <li>
              • <strong>Murakkablik.</strong> "Bir stakan suv ichish" — 20 kun. "20 daqiqa yugurish"
              — 100+ kun.
            </li>
            <li>
              • <strong>Trigger aniqligi.</strong> Bir xil vaqt, bir xil kontekst = tez o'rganish.
            </li>
            <li>
              • <strong>Uzilishlar.</strong> Bir kunni tashlab qo'ysang — dunyo qulamaydi. Ikki kun
              ketma-ket tashlab qo'ysang — halqa buziladi.
            </li>
            <li>
              • <strong>Dopamin qaytalanish.</strong> Har muvaffaqiyatdan keyin miya "tasdiq" olishi
              kerak.
            </li>
          </ul>
          ...
          <p className="mt-3 leading-relaxed text-muted-foreground">
            21 kun — bu shunchaki boshlanish. 66 kun — bu maqsad. Life Order aynan shu diapazonda
            ishlaydi: <strong>7 kunlik sprint</strong> (issiqroq bosqich) yoki{" "}
            <strong>30 kunlik reset</strong> (chuqurroq singdirish). Har kunlik 3 mikro-vazifa,
            streak, Shield tizimi — bu 66 kunga yetib borish uchun mo'ljallangan.
          </p>
          ...
          <div className="mt-10 rounded-[var(--radius)] border border-primary/40 bg-card/40 p-6">
            ...
            <p className="mt-2 font-ui text-sm text-muted-foreground">
              ...
              <em>How are habits formed: Modelling habit formation in the real world.</em> European
